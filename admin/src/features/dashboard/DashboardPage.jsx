...
function DashboardPage() {
  ...
  const stats = [
    ...
    { title: "Pending Orders", value: String(statsData?.totalPendingOrders || 0), subtitle: "Awaiting confirmation" },
    { 
      title: "Gross Revenue", 
      value: `PKR ${(graphData?.revenueVsRefunded?.find(d => d.name === 'Revenue')?.value || 0).toLocaleString()}`, 
      subtitle: "Total artisan sales" 
    }
  ];
