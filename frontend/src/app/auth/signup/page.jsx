...
export default function SignupPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#f5ede8] px-4 py-10">
      <div
        className="flex rounded-2xl overflow-hidden w-full max-w-200 pt-12"
        style={{ boxShadow: "0 8px 48px 0 rgba(80,30,40,0.13)" }}
      >
        {/* Left: Full-bleed image with overlay quote */}
        <div className="relative hidden md:block w-85 min-w-70 shrink-0">
          <Image
            src="/Images/colection_img_1.jpg"
            alt="Perfume"
            fill
          ...
          <div className="absolute bottom-0 left-0 right-0 px-7 pb-8">
            <p
              className="text-white font-serif text-[1.35rem] leading-snug mb-2"
              style={{
                fontStyle: "italic",
                fontWeight: 400,
        ...
        <div className="flex-1 bg-white flex flex-col justify-center px-10 py-10">
          <h1
            className="font-serif text-[2rem] text-[#6b3a44] font-normal mb-1 leading-tight"
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <div className="flex gap-3">
              <div className="flex flex-col gap-1.25 w-1/2">
                <label
                  htmlFor="password"
                  className="text-[11px] font-semibold uppercase tracking-[0.13em] text-[#7e525c] font-sans"
                >
