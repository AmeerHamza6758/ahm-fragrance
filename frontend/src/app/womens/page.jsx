...
export default function WomensPage() {
  ...
  const filters = {};
  if (activeCategory === "all") filters.category = "women";
  else if (activeCategory === "men") filters.category = "men";
  // bestsellers: no category filter
    ...
    <main className="bg-[#fdf9f5] min-h-screen pt-21">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        <div className="grid grid-cols-3 gap-4 sm:gap-6">
          {[
            { id: "men", label: "For Men", img: "/Images/for-him.svg" },
            { id: "all", label: "For Women", img: "/Images/for-her.svg" },
            {
              id: "bestsellers",
              label: "Best Sellers",
